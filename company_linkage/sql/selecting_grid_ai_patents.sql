-- Pulling every AI-associated patent family id linked to every grid id of any assignee for that patent
...
create or replace table ai_companies_visualization.grid_ai_patents as
